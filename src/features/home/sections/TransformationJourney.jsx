...
const TransformationJourney = () => {
  ...
  const styles = {
    ...
    leftCard: {
      ...
      background: `linear-gradient(to right, rgba(28,35,28,0.96) 0%, rgba(44,54,44,0.85) 60%, rgba(44,54,44,0.4) 100%), url('/images/external/heroes/unsplash_photo-1506126613408-eca07ce68773.jpg')`,
    ...
    rightCard: {
      ...
      width: "100%",
      minHeight: isMobile ? "auto" : "530px",
      background: `linear-gradient(to right, rgba(250,243,232,0.98) 35%, rgba(250,243,232,0.85) 65%, rgba(250,243,232,0.2) 100%), url('/images/external/heroes/unsplash_photo-1506126613408-eca07ce68773.jpg')`,
      backgroundSize: "cover",
