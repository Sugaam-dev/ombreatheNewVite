...
const Accordion = () => {
  ...
  const faqData = useMemo(
    () => ({
      training: [
        {
          title: "What is Ombreathe's teacher training program?",
          content:
            "Ombreathe's teacher training program is a comprehensive course that aims to provide students with the knowledge and skills needed to become a certified yoga instructor.",
        },
        {
        ...
        },
        {
          ...
          content:
            "Ombreathe's teacher training program covers a variety of yoga styles, including Hatha, Vinyasa, Kundalini, Prenatal, and Ayurveda yoga.",
        },
        {
        ...
        {
          title:
            "What are the benefits of enrolling in Ombreathe's teacher training program?",
          content:
        ...
        },
        {
          ...
          content:
            "Yes, Ombreathe offers a scholarship program for eligible students who demonstrate financial need and a commitment to their yoga practice.",
        },
      ],
      retreats: [
        {
      ...
      <div className="accordion-container">
        ...
        <div className="section-header">
          ...
          <p className="section-subtitle">
            {activeCategory === "training"
              ? "Everything you need to know about Ombreathe's certification program"
