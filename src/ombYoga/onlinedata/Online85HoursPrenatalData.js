export const Online85HoursPrenatalData = {
  heroSection: {
    colors: {
      cream: "#F5EFE8",
      goldLight: "#C8874A",
    ...
    hero: {
      location: "Online · 85-Hour Prenatal Specialization",
  ...
  communitySection: {
    ...
    content: {
      ...
      subtitle:
        "Are you looking to support women through one of the most beautiful and challenging times in life? Give us a chance to guide you through this specialization, wholeheartedly.",
      stats: [
        { value: "14", label: "Course Videos", icon: "award" },
      ...
      bottomText1:
        "Across yoga philosophy, asana suited to each trimester, pregnancy-safe pranayama, nutrition, meditation, mantra and human anatomy, this course prepares you to support a pregnant student's physical, spiritual and emotional wellbeing through every stage of pregnancy.",
      bottomText2:
        "Supporting a student through her pregnancy is one of the most meaningful ways a yoga teacher can serve. Our experienced teachers will be there to help you on this journey with any questions you may have.",
    },
  },
    ...
    content: {
      block1: {
        ...
        paragraphs: [
          ...
          "Through this course you'll learn to support women through a life-changing time, while gaining a specialization that adds genuine depth to your teaching practice.",
        ],
      },
      block2: {
        title: "85 Hour Prenatal Yoga Teacher Training Course & Certification",
        paragraphs: [
          "This course covers the yoga philosophy and asanas best suited to pregnant students, along with pranayama that's safe to practice during pregnancy. Nutrition, meditation, mantra and human anatomy round out this fast-track, theory-and-practice-balanced program.",
          "You'll also learn about each trimester, common problems that arise during pregnancy, and Ayurveda. The course can be taken alongside the 200, 300 or 500-Hour YTTC, and the Yoga Alliance certification opens up further career possibilities, all delivered online with teaching modalities specific to expectant mothers.",
        ],
      ...
      block3: {
        ...
        paragraphs: [
          "You'll enjoy the full benefits of Yoga Alliance accreditation, which also lets you apply for Registered Yoga Teacher certification when combined with other long-term courses. The 85-Hour Prenatal YTT Course helps you gain genuine mastery over prenatal yoga, with the certification process including a proper online examination conducted by our school.",
        ],
      },
      block4: {
        title: "What Are Your Career Options After The 85 Hour Prenatal YTT Course?",
        paragraphs: [
          "After completing this course, you can train expectant mothers through the various stages of pregnancy and childbirth preparation, and you can begin teaching prenatal yoga as soon as you finish — or incorporate the discipline into your own yoga school. You'll also learn to modify postures based on each client's individual needs, supported by the Yoga Alliance and RYT certification that lets you teach worldwide.",
        ],
        advantagesTitle: "Advantages Of The Yoga Alliance Certification",
        advantages: [
          { title: "Eligibility", desc: "You are eligible for the certificate." },
          { title: "RYT Certification", desc: "You can apply for RYT or Registered Yoga Teacher certification." },
          { title: "Credibility", desc: "You gain credibility as a practitioner and teacher." },
          { title: "Global Yoga Community", desc: "Become a part of the global yoga community." },
          { title: "Connect Virtually", desc: "Connect virtually with other students and form friendships." },
          { title: "Access To Workshops", desc: "Get access to workshops and advanced-level courses free of cost or at very low prices." },
        ],
      },
    },
  },
  ...
  promoSection: {
    ...
    content: {
      ...
      features: [
        {
          icon: "award",
          title: "14 Course Videos",
          sub: "Pre-recorded lessons covering the full prenatal curriculum",
        },
        {
          icon: "bed",
          title: "Study Materials",
          sub: "Prenatal manual and study materials included",
        },
        {
          icon: "award",
        ...
        },
        {
          ...
          sub: "Live classes, closed group access and post-study support",
        },
      ],
      images: {
  ...
  receiveSection: {
    ...
    content: {
      ...
      highlight: "85-Hour Prenatal Course",
      subtitle:
        "Your life is a gift of the Divine, cherish it — here's everything included in your 85-hour prenatal yoga teacher training.",
      items: [
        {
          icon: "award",
          title: "Certificate",
          desc: "Course completion certification, accredited by Yoga Alliance.",
        },
        {
          icon: "level",
          title: "Course Level",
          desc: "Course level — Beginner to Intermediate.",
        },
        {
          icon: "play",
          title: "Pre-Recorded Videos",
          desc: "14 pre-recorded course videos covering the full prenatal curriculum.",
        },
        {
          icon: "calendar",
          title: "Course Access",
          desc: "Course access: 6 months.",
        },
        {
          icon: "layers",
          title: "In-Depth Understanding",
          desc: "In-depth understanding of prenatal asana, pranayama and the impact on the expectant mother.",
        },
        {
          icon: "percent",
          title: "Discount",
  ...
  practiceSection: {
    ...
    content: {
      ...
      subtitle:
        "Build a complete foundational understanding of yoga for pregnancy — trimester-specific asana, pregnancy-safe pranayama, nutrition and meditation.",
      practices: [
        {
          label: "Trimester-Specific Asana",
          desc: "Joint movements and asana sequences adapted for the 1st, 2nd and 3rd trimesters",
          icon: "sun",
          img: "https://wallpapers.com/images/hd/yoga-background-2rmnmb16t7q2lj98.jpg",
        },
        {
          label: "Pranayama & Meditation",
          desc: "Abdominal, thoracic and clavicular breathing, Nadi Shodhan, Bhramari and Pranava Meditation",
          icon: "wind",
          img: "https://images.unsplash.com/photo-1593811167562-9cef47bfc4d7?w=800&q=80",
        },
        {
          label: "Philosophy & Nutrition",
          desc: "Prenatal yoga philosophy and the samskaras of pregnancy, plus nutrition for pregnant women",
          icon: "feather",
      ...
      specials: [
        ...
        },
        {
          ...
          desc: "6 months of access to 14 videos — complete the course in your own time, on your own schedule",
          icon: "shield",
        },
        {
          title: "Stay Connected",
          desc: "Closed group access and unlimited post-study support keep you connected throughout",
          icon: "sparkles",
        },
      ],
    },
  ...
  curriculumSection: {
    ...
    content: {
      eyebrow: "Curriculum",
      title: "85 Hours Pre-Natal Yoga Teacher Training Course",
      highlight: "Curriculum",
      subtitle:
        "A focused, eight-module course covering manuals & books, philosophy, asana, pranayama, nutrition for pregnant women, meditation, mantra meditation and a final exam.",

      courses: [
        {
          title: "Manual and Books",
          icon: "book",
          items: [
            "Prenatal manual",
          ],
        },
        {
          ...
          icon: "feather",
          items: [
            "Purpose of prenatal yoga & preparation to conceive",
            "Garbhadhana, Punsavana, Simontanayana & Jatakarma samskaras — the purification phases of pregnancy",
            "Chatur-Varna Ashram — the four phases of human life",
            "Chitta Vritti Nirodha & mindfulness during pregnancy",
          ],
        },
        {
          title: "Asana",
          icon: "sun",
          items: [
            "Introduction to prenatal yoga & the three trimesters",
            "Joint movements",
            "Asana sequences for the 1st trimester",
            "Asana sequences for the 2nd trimester",
            "Asana sequences for the 3rd trimester",
          ],
        },
        {
          title: "Pranayama",
          icon: "wind",
          items: [
            "Introduction & preparation for Pranayama",
            "Asana for Pranayama practice",
            "Abdominal, thoracic, clavicle & natural breathing practice",
            "Yoni Mudra, Nadi Shodhan, Surya & Chandra Nadi Pranayama",
            "Seetkari, Sheetali, Bhramari & Udgeeth Pranayama",
          ],
        },
        {
          ...
          icon: "leaf",
          items: [
            "Nutritional stages & categories of nutrients",
            "Common doubts and questions",
            "Recommended daily intake of nutrients",
            "Discomforts during pregnancy & diet for pregnancy",
          ],
        },
        {
          title: "Meditation",
          ...
          items: [
            ...
            "Natural & clavicular breathing practice",
            "Pranava Meditation & its benefits",
            "Mudras & Prana Dhyana practice",
          ],
        },
        {
          ...
          icon: "users",
          items: [
            "Om mantra & Ganesh mantras",
            "Gurur Brahma, Gurur Vishnu",
            "Vishnu Stotram & Maha Mantra",
            "Surya Mantra & Devi mantras",
      ...
      phases: [
        {
          title: "Foundation",
          days: "Modules 1–2",
          desc: "Manual and Books, and Philosophy of prenatal yoga",
          color: "#2E5018",
        },
        {
          title: "Practice",
          days: "Modules 3–5",
          desc: "Asana, Pranayama and Nutrition for Pregnant Women",
          color: "#4A7A2A",
        },
        {
          title: "Integration",
          days: "Modules 6–8",
          desc: "Meditation, Mantra Meditation and the final exam",
          color: "#6A9A40",
        },
      ],
  ...
  benefitsSection: {
    ...
    content: {
      ...
      eligibility: {
        ...
        items: [
          "Any yoga practitioner can pursue the program alongside the 200 or 300-Hour Yoga TTC",
        ],
      },
    ...
    content: {
      ...
      massages: [
        ...
        },
        {
          id: 3,
          title: "Yogi Naveen",
          tagline: "Hatha, Ashtanga & Prenatal — teaching Yoga Teacher Training since 2015, having trained over 1,000 teachers in India, China and Vietnam, with a Master's in Yogic Science and a certified Prenatal and postnatal yoga teacher trainer credential.",
    ...
    content: {
      ...
      spots: [
        ...
        },
        {
          ...
          distance: "6 Months",
          desc: "Access all 14 videos, the prenatal manual and live class links in one place.",
          icon: "globe",
        },
        {
      ...
      stats: [
        ...
        { label: "Videos", value: "14", icon: "sparkles" },
      ...
      faqs: [
        {
          ...
          answer:
            "You get 6 months of access to all 14 pre-recorded course videos and study materials.",
        },
        {
          question: "Do I get a Yoga Alliance certificate?",
          answer:
            "Yes, you receive Yoga Alliance accreditation and a certificate of completion after finishing the course and its examination.",
        },
        {
          question: "Can I take this course alongside another YTTC?",
          answer:
            "Yes, the 85-Hour Prenatal YTTC can be done in conjunction with the 200, 300 or 500-Hour Yoga TTC, or as a standalone specialization.",
        },
        {
          question: "What format does the course take?",
          answer:
            "It combines pre-recorded videos, live sessions, PDF notes and post-study support, accessible on mobile, desktop and tablet.",
        },
        {
          question: "Will I be able to teach immediately after this course?",
          answer:
            "Yes — after completion you can begin teaching prenatal yoga, training expectant mothers through the different stages of pregnancy.",
        },
      ],
    },
  },
