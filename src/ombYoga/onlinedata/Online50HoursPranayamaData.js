export const Online50HoursPranayamaData = {
  heroSection: {
    colors: {
      cream: "#F5EFE8",
      goldLight: "#C8874A",
    ...
    hero: {
      location: "Online · 50-Hour Breathwork Specialization",
    ...
    certificates: [
      ...
      { img: "https://www.ombreathe.in/static/media/YACEP.50cf2e991c78fbe3a13d.png", label: "Pranayama" },
    ],
  ...
  communitySection: {
    ...
    content: {
      ...
      subtitle:
        "Pranayama is the very foundation of the yogic journey and the fourth limb of Patanjali's Yoga Sutra. Give us a chance to deepen your breathwork practice, wholeheartedly.",
      stats: [
        { value: "46", label: "Course Videos", icon: "award" },
      ...
      bottomText1:
        "Across the aspects of breathing, levels of Prana, the three Gunas, postures for Pranayama, breathing patterns and the major Pranayama techniques — including Bhastrika, Bhramari, Sheetali and Nadi Sodhanam — this course breaks down every part of the breathwork practice for you.",
      bottomText2:
        "After completing this course you'll be more comfortable teaching other forms of yoga too. Our experienced teachers will be there to help you on this journey with any questions you may have.",
    },
  },
  ...
  aboutSection: {
    ...
    content: {
      ...
      block2: {
        title: "50 Hour Online Pranayama Course & Certification",
        paragraphs: [
          "Pranayama is the very foundation of your yogic journey and the fourth limb of Patanjali's Yoga Sutra. After completing this course you'll be more comfortable teaching other forms of yoga too.",
          "We provide simple, easy-to-understand course modules that you can practice from home, with 6 months of access to the course content. The course adds a supplementary qualification to your 200 or 300-Hour Hatha Yoga TTC — the 200-Hour course remains the minimum requirement to teach globally — and anyone wanting to deepen their knowledge of yoga can apply.",
        ],
      ...
      block3: {
        ...
        paragraphs: [
          "Yoga Alliance Certification is a major boost for any yoga practitioner. You can get accredited by our certified school, which teaches authentic yoga, and we provide the certificate after you've successfully completed the course and its examination. You can also apply for Registered Yoga Teacher certification after completing the 200-Hr YTTC — which is why joining this specialized Pranayama course is worthwhile.",
        ],
      },
      block4: {
  ...
  promoSection: {
    ...
    content: {
      eyebrow: "50 Hour Pranayama Course",
      title: "Course",
      ...
      features: [
        {
          icon: "wind",
          title: "46 Course Videos",
          sub: "Pre-recorded lessons covering the full breathwork curriculum",
        },
        {
          icon: "bed",
        ...
        },
        {
          ...
          sub: "Issued after the online examination",
        },
        {
          icon: "compass",
  ...
  receiveSection: {
    ...
    content: {
      ...
      highlight: "50-Hour Pranayama Course",
      subtitle:
        "Your life is a gift of the Divine, cherish it — here's everything included in your 50-hour online Pranayama course.",
      items: [
        {
          icon: "award",
          title: "Certificate",
        ...
        },
        {
          ...
          desc: "In-depth understanding of Pranayama and its practices.",
        },
        {
          icon: "play",
          title: "Pre-Recorded Videos",
          desc: "46 pre-recorded course videos.",
        },
        {
          icon: "level",
          title: "Course Level",
  ...
  practiceSection: {
    ...
    content: {
      ...
      title: "Foundation of",
      highlight: "Pranayama & Breathwork",
      subtitle:
        "Build a complete foundational understanding of Pranayama — postures for breathwork, breathing patterns and the major Pranayama techniques.",
      practices: [
        {
          label: "Postures For Pranayama",
          desc: "Sukhasana, Swastikasana, Vajrasana, Siddhasana, Padmasana and Maitri Asana",
          icon: "sun",
          img: "https://wallpapers.com/images/hd/yoga-background-2rmnmb16t7q2lj98.jpg",
        },
        {
          label: "Breathing Patterns",
          desc: "Clavicular, thoracic and diaphragmatic breathing, plus Yogic Breathing",
          icon: "wind",
      ...
      specials: [
        ...
        },
        {
          ...
          desc: "6 months of access to 46 videos — complete the course in your own time, on your own schedule",
          icon: "shield",
        },
        {
  ...
  curriculumSection: {
    ...
    content: {
      ...
      subtitle:
        "A single, in-depth Pranayama module covering the aspects of breathing, levels of Prana, postures for practice, breathing patterns, the major Pranayama techniques and Pranayama philosophy.",

      courses: [
        {
          title: "Pranayama Lesson",
          icon: "wind",
          items: [
            "Welcome to Pranayama & introducing Pranayama",
            "Aspects of breathing & levels of Prana",
            "Books and scriptures of Pranayama",
            "Postures for Pranayama — Sukhasana, Swastikasana, Vajrasana, Siddhasana, Padmasana & Maitri Asana",
            "Breathing patterns — clavicular, thoracic & diaphragmatic breathing",
            "Pranava, Nadi Sodhanam, Bhastrika & Kapal Bhati Pranayama",
            "Panchakosha-Pranayama & Pranayama philosophy",
      ...
      phases: [
        {
          title: "Foundation",
          days: "Lessons 1–3",
          desc: "Introduction to Pranayama, aspects of breathing and the levels of Prana",
          color: "#2E5018",
        },
        {
          title: "Practice",
          days: "Lessons 4–6",
          desc: "Postures for Pranayama and the core breathing patterns",
          color: "#4A7A2A",
        },
        {
          title: "Integration",
          days: "Lessons 7–8",
          desc: "Major Pranayama techniques, Pranayama philosophy and the final assignment",
          color: "#6A9A40",
        },
      ],
  ...
  benefitsSection: {
    ...
    content: {
      ...
      eligibility: {
        title: "Who Is Eligible For The 50 Hr Online Pranayama Course",
        items: [
          "Any yoga practitioner or trainer who wants to deepen their knowledge",
          "Can be done simultaneously with the 200-Hour Yoga TTC or higher, or after completing it",
          "Beginners can take the course, but will be able to teach only after completing the 200-Hr YTTC",
        ],
      },
    ...
    content: {
      ...
      spots: [
        ...
        },
        {
          ...
          distance: "6 Months",
          desc: "Access all 46 videos and study materials in one place.",
          icon: "globe",
        },
        {
      ...
      stats: [
        ...
        { label: "Videos", value: "46", icon: "sparkles" },
      ...
      faqs: [
        {
          ...
          answer:
            "You get 6 months of access to all 46 pre-recorded course videos and study materials.",
        },
        {
          question: "Will I receive a Yoga Alliance certificate?",
          answer:
            "The course awards a certificate of completion, and you can also apply for Registered Yoga Teacher certification after completing a 200-Hour YTTC.",
        },
        {
          question: "Can I take this course alongside another YTTC?",
          answer:
            "Yes, most students take this Pranayama course alongside the 200-Hour Yoga TTC or higher, since 200 hours is the basic requirement to teach yoga worldwide.",
        },
        {
          question: "Can a complete beginner join this course?",
          answer:
            "Yes, beginners can take the course to deepen their knowledge, but they will only be able to teach Pranayama after completing the 200-Hour YTTC.",
        },
        {
