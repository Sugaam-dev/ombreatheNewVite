...
const OnlineFoodSection = ({ data }) => {
  const { colors, content } = data;

  // Default to the first meal's key instead of a hardcoded value,
  // since this section is reused for different course types whose
  // meals/tabs don't always share the same keys (e.g. online courses
  // use "videos" / "manuals" / "live" instead of "breakfast").
...
export default OnlineFoodSection;