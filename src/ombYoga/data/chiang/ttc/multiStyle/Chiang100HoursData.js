export const Chiang100HoursData= {
  heroSection: {
    ...
    hero: {
      location: " Chiang Mai · 100-Hour Multi Style",
    ...
    gains: [
      ...
      "Personal transformation in Chiang Mai's spiritual environment",
    ],
    ...
    content: {
      bottomText:
        "Receive a Yoga Alliance recognized 100-hour certificate and begin your teaching transformation journey in Chiang Mai.",
    },
  },
  ...
  communitySection: {
    ...
    content: {
      ...
      subtitle:
        "Experience authentic multi style yoga in Chiang Mai with Yoga Alliance certified teachers, deep philosophy, and life-changing practices.",
      stats: [
      ...
      bottomText2:
        "Learn in a peaceful Chiang Mai environment while transforming your body, mind, and soul.",
    },
  },
    ...
    content: {
      ...
      features: [
        ...
        },
        {
          ...
          sub: "Kirtan, ceremonies & Chiang Mai culture",
        },
      ],
      images: {
        main:
  ...
  transformationSection: {
    ...
    content: {
      bgImage:
        "https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=1600&q=80",
      quoteStart: "Transform your life through",
      highlight: "dynamic multi style yoga",
      quoteEnd: "in the spiritual heart of Chiang Mai",
      description:
        "Discover the dynamic principles of classical Ashtanga, Hatha, and Vinyasa flow through guided practice, ancient wisdom, and a supportive community designed to nurture your growth and inspire lasting change.",
    },
  },
  ...
  curriculumSection: {
    ...
    content: {
      ...
      cta: {
        ...
        desc:
          "Transform your body, mind, and lifestyle through structured 100-hour yoga teacher training in Chiang Mai.",
  ...
  locationSection: {
    ...
    content: {
      ...
      subtitle:
        "Located in  surrounded by jungle, temples, and nature.",
  ...
  content: {
    ...
    subtitle:
      "Find answers to the most common questions about 100 Hours Ombreathe's yoga teacher training program in Chiang Mai.",
