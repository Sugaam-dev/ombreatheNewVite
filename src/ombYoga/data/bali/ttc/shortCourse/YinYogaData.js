...
export const YinYogaData = {
  heroSection: {
    ...
    certificates: [
      { img: "/images/cirtificats/200.png", label: "Yin Yoga" },
  ...
  transformationSection: {
    colors: {
      ...
      goldLight: "#5ABE90",
      overlay:
        "linear-gradient(180deg, rgba(13,46,32,0.75), rgba(13,46,32,0.95))",
  ...
  teacherTrainingFaq: {
    ...
    content: {
      ...
      subtitle:
        "Find answers to the most common questions about Ombreathe's Yin Yoga Teacher Training in Bali.",
