...
export const AcroYogaData = {
  ...
  transformationSection: {
    colors: {
      ...
      goldLight: "#E09050",
      overlay:
        "linear-gradient(180deg, rgba(42,16,8,0.75), rgba(42,16,8,0.95))",
  ...
  teacherTrainingFaq: {
    ...
    content: {
      ...
      subtitle:
        "Find answers to the most common questions about Ombreathe's Acro Yoga teacher training in Bali.",
      ...
      faqs: [
        ...
        {
          question: "Why choose Ombreathe in Bali for Acro Yoga?",
          answer:
