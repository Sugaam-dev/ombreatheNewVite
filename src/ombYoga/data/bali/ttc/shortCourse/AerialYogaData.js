...
export const AerialYogaData = {
  heroSection: {
    ...
    certificates: [
      { img: "/images/cirtificats/200.png", label: "Aerial Yoga" },
  ...
  transformationSection: {
    colors: {
      ...
      goldLight: "#50AAEE",
      overlay:
        "linear-gradient(180deg, rgba(10,30,56,0.75), rgba(10,30,56,0.95))",
  ...
  teacherTrainingFaq: {
    ...
    content: {
      ...
      subtitle:
        "Find answers to the most common questions about Ombreathe's aerial yoga teacher training in Bali.",
      ...
      faqs: [
        ...
        {
          question: "Why choose Ombreathe in Bali for aerial yoga?",
          answer:
