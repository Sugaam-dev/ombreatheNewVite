...
export const BaliAyurvedicTreatmentTTCData = {
  ...
  communitySection: {
    ...
    content: {
      ...
      subtitle:
        "Ombreathe in Bali delivers pure Ayurvedic treatment disciplines, bringing body, mind, and spirit into total alignment using authentic medicated herbal oils.",
      stats: [
  ...
  transformationSection: {
    colors: {
      ...
      goldLight: "#E67E22",
      overlay:
        "linear-gradient(180deg, rgba(62,39,35,0.8), rgba(27,16,15,0.97))",
