...
export const RishikeshKundali200HoursData = {
  ...
  transformationSection: {
    colors: {
      ...
      goldLight: "#F1C40F",
      overlay:
        "linear-gradient(180deg, rgba(10,47,45,0.78), rgba(3,13,12,0.96))",
    ...
    content: {
      ...
      quoteStart: "Nothing from outside can fulfill you",
      highlight: "but yourself; your true happiness is safely within",
      quoteEnd: "activated by timeless divine phenomena",
      description:
        "Our skilled yogis and master teachers safely lead you through intense Kundalini awakening tracks. By utilizing tantric protocols and rhythmic discipline, you redirect your energy upward to touch states of deep inner peace, bliss, and higher observation fields.",
    },
  },
