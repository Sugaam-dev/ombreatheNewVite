export const Dharamshala100HoursData = {
  ...
  communitySection: {
    ...
    content: {
      ...
      subtitle:
        "Experience authentic yoga in Dharamshala — the yoga capital of the world — with Himalayan masters, deep philosophy and life-changing practice.",
      stats: [
  ...
  transformationSection: {
    ...
    content: {
      ...
      highlight: "Dharamshala — the birthplace of yoga",
      quoteEnd: "beside the sacred Ganges and eternal Himalayas",
      description:
        "Dharamshala possesses awe-inspiring divine energy. Submerge yourself in authentic Indian culture and ancient Himalayan tradition as you spend 13 days learning in the house of ancient rulers and sages — the yoga capital of the world.",
    },
  },
  ...
  curriculumSection: {
    ...
    content: {
      ...
      cta: {
        title: "Begin Your Yoga Journey in Dharamshala",
        desc:
  ...
  teacherTrainingFaq: {
    ...
    content: {
      ...
      subtitle:
        "Find answers to the most common questions about World Peace Yoga School's 100-hour yoga teacher training in Dharamshala.",
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "The closest and most convenient airport is Dehradun (Jolly Grant Airport) — just 30 minutes from Dharamshala. Free taxi pick-up from Dehradun Airport is included in the course fee. If flying to New Delhi, Delhi to Dharamshala by car is a 6-hour journey.",
        },
        {
          question: "How can I reach Dharamshala from Delhi and how much does it cost?",
          answer:
            "Delhi airport to Dharamshala by car is 6 hours. We have a transportation package for $150 covering airport pick-up and return transfer. One-way from Delhi airport to Dharamshala is $75. An alternative is to travel by train from New Delhi to Haridwar and then by car to Dharamshala. Free taxi pick-up is included from Dehradun Airport.",
        },
        {
          question: "Is it safe to travel alone to Dharamshala?",
          answer:
            "Yes — it is very safe to travel alone to Dharamshala. Many tourists do it every year. If you have never been to India before, it can be helpful to fly directly to Dehradun Airport (30 min from Dharamshala) rather than navigating from Delhi, as local buses and trains can be complex for first-time visitors.",
        },
        {
          question: "Will you handle travel arrangements once I arrive in India?",
          answer:
            "Yes — with advanced notice we will arrange transportation directly from Dehradun Airport (free of charge), the bus or train station. Upon arriving in Dharamshala we will help you with directions to reach our school at Laxman Jhula.",
        },
        {
