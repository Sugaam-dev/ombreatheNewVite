...
export const Chiang50HourData = {
  heroSection: {
      ...
      hero: {
        location: " Chiang Mai · 50-Hour Multi Style",
        title: "Multi-Style Yoga Training in Chiang Mai",
      ...
      gains: [
        ...
        "Taste of authentic yogic lifestyle in Chiang Mai",
  ...
  highlightsSection: {
    community: {
        ...
        content: {
          ...
          subtitle:
            "Experience authentic multi style yoga in Chiang Mai with expert teachers, deep philosophy, and life-changing practices.",
          stats: [
    ...
    curriculum: {
        ...
        content: {
          ...
          cta: {
            ...
            desc:
              "Transform your body, mind, and lifestyle through structured multi style yoga training in Chiang Mai.",
        ...
        rooms: [
          {
            ...
            desc: "Comfortable shared rooms surrounded by lush tropical gardens in the heart of Chiang Mai.",
            features: [
              "Twin sharing",
              "Garden access",
              "En-suite bathroom",
          ...
          },
          {
            ...
            desc: "Private room with peaceful Chiang Mainese ambience and a tranquil vibe.",
            features: [
              "Private ensuite",
              "Personal space",
              "Mini fridge",
  ...
  faqSection: {
    ...
    content: {
      ...
      faqs: [
        {
          question: "What is Ombreathe's teacher training program?",
          answer:
            "Ombreathe's teacher training program is a comprehensive course that provides students with the knowledge and skills required to become a certified yoga instructor.",
        },
        {
